...
registerFont(__dirname + `/cache/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("its.showrob.bbz", 930, 540)
    ctx.fillText("SHOWROB-143", 930, 610)
    ctx.fillText("Showrob Khan", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
