...
usages: "facebook cover photo make by simanto",
cooldowns: 0,
dependencies: {
    "fs-extra": "",
    "request": "",
...
if ((this.config.credits) != "Showrob") { return api.sendMessage(`[ WARNING ] - Itz Showrob Don't credits modules ${this.config.name} was changed to ${this.config.credits}  ADMINBOT ${global.config.BOTNAME} 😐 Stop now!!!`, event.threadID, event.messageID)}
 const request = require('request');
  ...
  else return api.sendMessage(`Cover Maker SHOWROB \n\n♻️আপনি প্রধান নাম চয়ন করেছেন: ${args.join(" ").toUpperCase()}\n\n(এই বার্তার উত্তর দিন এবং আপনার দ্বিতীয় নাম নির্বাচন করুন)`,event.threadID, (err, info) => {
...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  switch (handleReply.type) {
    case "tenphu": {
      ...
      return api.sendMessage(`♻️আপনি উপ-নাম বেছে নিয়েছেন  : :${event.body.toUpperCase()}\n\n(এই বার্তার উত্তর আপনার ফোন নম্বর লিখুন)`,threadID, function (err, info) {
        return global.client.handleReply.push({
          type: "sdt",
          name: `fbcover`,
          author: senderID,
    ...
    case "create": {
      ...
      api.unsendMessage(handleReply.messageID);
      api.sendMessage(` SHOWROB BOT কভার বানাচ্ছে....!`,threadID, (err, info) => {
      setTimeout(() => {
      ...
      let hieuung = (
        await axios.get(encodeURI(`https://i.postimg.cc/HsghXQfh/20230105-163934.png`), {
          responseType: "arraybuffer",
        })
      ).data;
