...
module.exports.run = async function({ api, event, args }) {
 ...
 try {
  let data = await axios.get(`https://mainserver.nayan-api.repl.co/instagram/downloadpost?url==${content}`);
  ...
  file.on('finish', () => {
    ...
    api.sendMessage(`ERROR: SHOWROB API IS BUSY OR YOU HAVE BEEN BLOCKED FROM SHOWROB API`, event.threadID, event.messageID);  
   }
};